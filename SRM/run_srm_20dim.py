...
def run_20dim_SRM_all(tr_times, tst_times):
    W_test = {}
    for mask in mask_types:
        W, S, test_data = run_20dim_SRM(mask, tr_times, tst_times)
        W_test[mask] = (W, S, test_data)
    return W_test


def run_20dim_SRM(mask_type, tr_times, tst_times):
    dataset = '20dim-SRM-' + mask_type
    ...
    working_path = '/fastscratch/knv/srm20dim-sherlock-new/'
...
if __name__ == '__main__':
    run_20dim_SRM_all(xrange(1973/2+1), xrange(1973/2+1, 1973))
